...
pub fn routes() -> Router {
    ...
    #[openapi(
        ...
        components(schemas(
            ...
            GetGroupApplicationParams, GroupOwnerType, GroupOwnerInfo)),
        tags(
